    ...
    <Box display="flex" flexDirection="column">
      ...
      <Stack direction="row" my="1rem">
        <Button
          variant="contained"
          onClick={
          async()=>await addAddress(token,newAddress)
          }
        >
          Add
        </Button>
    ...
    <>
      ...
      <Grid container>
            ...
            <Divider />
              ...
              {addresses.all.length?(
                addresses.all.map((item)=>(
                  <Box className={addresses.selected===item._id?'address-item selected'
        ...
        <Grid item xs={12} md={3} bgcolor="#E9F5E1">
          <Cart isReadOnly products={products} items={items} hasCheckButton />
        </Grid>
      </Grid>
      <Footer />
    </>
